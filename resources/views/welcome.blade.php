...
@section('content')
    ...
    <section class="relative bg-slate-900 overflow-hidden" id="home">
        ...
        <div class="relative max-w-7xl mx-auto px-4 sm:px-6 py-24 lg:py-40">
            <div class="max-w-2xl">
                <span
                    class="inline-block px-4 py-1.5 mb-6 text-xs font-bold tracking-widest text-primary uppercase bg-primary/10 border border-primary/20 rounded-full">Academic
                    Excellence</span>
                ...
                <div class="flex flex-col sm:flex-row gap-4">
                    <button
                        class="flex items-center justify-center gap-2 px-8 py-4 bg-primary text-white rounded-xl text-base font-bold transition-all hover:scale-105">
    ...
    <section class="py-24 max-w-7xl mx-auto px-4 sm:px-6" id="about">
        <div class="grid lg:grid-cols-2 gap-16 items-center">
            <div class="relative">
                ...
                <div class="absolute -bottom-8 -right-8 bg-primary p-8 rounded-3xl hidden md:block max-w-xs shadow-xl">
            ...
            <div>
                <h3 class="text-primary font-bold tracking-widest uppercase text-sm mb-4">About the Library</h3>
        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6">
            ...
            <div class="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
                ...
                <div
                    ...
                    <div
                        class="size-14 bg-primary/10 text-primary rounded-2xl flex items-center justify-center mb-6 group-hover:bg-primary group-hover:text-white transition-colors">
    ...
    <section class="py-24 max-w-7xl mx-auto px-4 sm:px-6" id="featured-books">
        <div class="flex flex-col md:flex-row md:items-end justify-between mb-12">
            ...
            <a class="text-primary font-bold flex items-center gap-2 mt-4 md:mt-0 group" href="#">
                View Full Catalog
        ...
        <div class="grid grid-cols-2 lg:grid-cols-4 gap-8">
            ...
            <div class="flex flex-col">
                ...
                <span class="text-[10px] font-bold text-primary uppercase tracking-widest mb-1">Electrical</span>
            ...
            <div class="flex flex-col">
                ...
                <span class="text-[10px] font-bold text-primary uppercase tracking-widest mb-1">Civil</span>
            ...
            <div class="flex flex-col">
                ...
                <span class="text-[10px] font-bold text-primary uppercase tracking-widest mb-1">Computer Science</span>
            ...
            <div class="flex flex-col">
                ...
                <span class="text-[10px] font-bold text-primary uppercase tracking-widest mb-1">General Science</span>
            ...
            <div class="grid lg:grid-cols-3 gap-12">
                ...
                <div class="lg:col-span-2">
                    ...
                    <div class="space-y-4">
                        <!-- Notice Item -->
                        <div
                            class="p-6 bg-slate-50 dark:bg-slate-800/50 rounded-xl border-l-4 border-primary group cursor-pointer hover:bg-slate-100 dark:hover:bg-slate-800 transition-colors">
                    ...
                    <button class="mt-8 text-sm font-bold text-primary flex items-center gap-1">
                ...
                <div>
                    ...
                    <div class="bg-primary/5 dark:bg-slate-800 p-8 rounded-3xl border border-primary/10">
                        <ul class="space-y-4">
                            <li
                                ...
                                <span class="text-primary font-bold">8:00 AM - 8:00 PM</span>
                            </li>
                            <li
                                class="flex justify-between items-center pb-4 border-b border-slate-200 dark:border-slate-700">
                                <span class="font-semibold dark:text-slate-300">Saturday</span>
                                <span class="text-primary font-bold">9:00 AM - 4:00 PM</span>
                            </li>
    ...
    <section class="py-16 px-4" id="contact">
        <div class="max-w-7xl mx-auto">
            <div
                class="bg-primary rounded-[2rem] p-8 md:p-16 text-center text-white relative overflow-hidden shadow-2xl shadow-primary/30">
                ...
                <p class="text-primary-100 text-lg md:text-xl max-w-2xl mx-auto mb-10 relative z-10 opacity-90">
                    Search the library catalog and discover thousands of books and academic resources available at your
                    fingertips.
                </p>
                <div class="flex flex-col sm:flex-row gap-4 justify-center relative z-10">
                    <button
                        class="px-10 py-4 bg-white text-primary font-black rounded-xl hover:bg-slate-100 transition-all shadow-xl">
                        Search Library Catalog
                    </button>
                    <button
                        class="px-10 py-4 bg-primary/20 border border-white/30 text-white font-black rounded-xl backdrop-blur-sm hover:bg-primary/30 transition-all">
                        Register as Member
                    </button>
                </div>
            </div>
